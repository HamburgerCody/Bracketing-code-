...
update_word_list_button = tk.Button(button_frame, text="Update Word List", font=("Arial", 12), command=update_word_list)
update_word_list_button.grid(row=0, column=0, padx=5)

save_word_list_button = tk.Button(button_frame, text="Save Word List", font=("Arial", 12), command=save_word_list)
save_word_list_button.grid(row=0, column=1, padx=5)

load_word_list_button = tk.Button(button_frame, text="Load Word List", font=("Arial", 12), command=load_word_list)
