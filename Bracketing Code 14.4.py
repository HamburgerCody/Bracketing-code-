...
select_folder_button = tk.Button(app, text="Select Folder", font=("Arial", 14), command=lambda: select_folder())
select_folder_button.pack(pady=10)

# Button to process a selected Word document or folder
start_button = tk.Button(app, text="Start", font=("Arial", 14), command=lambda: [process_document(), process_folder_dialog()])
