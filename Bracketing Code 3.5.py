...
if __name__ == "__main__":
    while True:
        # Prompt the user for the path of the Word List
        word_list_path = input("Enter the path to the Word List text file (or 'q' to quit): ")

        if word_list_path.lower() == 'q':
            break

        # Read the word list from the specified text file
