...
process_document_button = tk.Button(app, text="Process Selected Word Document", font=("Arial", 14), command=process_document)
process_document_button.pack(pady=10)

# Button to process a folder
process_folder_button = tk.Button(app, text="Process Markdown Folder", font=("Arial", 14), command=process_folder_dialog)
...
select_document_button = tk.Button(app, text="Select Word Document", font=("Arial", 14), command=lambda: select_document())
