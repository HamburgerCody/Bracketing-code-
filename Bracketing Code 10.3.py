...
background_image = Image.open("background_image.png")  # Replace with your custom background image
background_photo = ImageTk.PhotoImage(background_image)

background_label = tk.Label(app, image=background_photo)
background_label.place(relwidth=1, relheight=1)

label = tk.Label(app, text="Word List", font=("Arial", 16), bg="#FFD700")
label.pack(pady=10)

text_box = tk.Text(app, height=8, width=50, font=("Arial", 12))
text_box.pack(padx=10, pady=5)

button_frame = tk.Frame(app, bg="#FFD700")
button_frame.pack()

update_word_list_button_image = Image.open("update_word_list_button_image.png")  # Replace with your custom button image
update_word_list_button_photo = ImageTk.PhotoImage(update_word_list_button_image)
update_word_list_button = ttk.Button(button_frame, image=update_word_list_button_photo, command=update_word_list)
update_word_list_button.grid(row=0, column=0, padx=5)

save_word_list_button_image = Image.open("save_word_list_button_image.png")  # Replace with your custom button image
save_word_list_button_photo = ImageTk.PhotoImage(save_word_list_button_image)
save_word_list_button = ttk.Button(button_frame, image=save_word_list_button_photo, command=save_word_list)
save_word_list_button.grid(row=0, column=1, padx=5)

load_word_list_button_image = Image.open("load_word_list_button_image.png")  # Replace with your custom button image
load_word_list_button_photo = ImageTk.PhotoImage(load_word_list_button_image)
load_word_list_button = ttk.Button(button_frame, image=load_word_list_button_photo, command=load_word_list)
load_word_list_button.grid(row=0, column=2, padx=5)

process_button_image = Image.open("process_button_image.png")  # Replace with your custom button image
process_button_photo = ImageTk.PhotoImage(process_button_image)
process_button = tk.Button(app, image=process_button_photo, command=process_document)
