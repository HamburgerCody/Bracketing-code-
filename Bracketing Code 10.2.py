...
label = tk.Label(app, text="Word List", font=("Arial", 16))
label.pack(pady=10)
...
update_word_list_button = ttk.Button(button_frame, text="Update Word List", style="TButton", command=update_word_list)
update_word_list_button.grid(row=0, column=0, padx=5)

save_word_list_button = ttk.Button(button_frame, text="Save Word List", style="TButton", command=save_word_list)
save_word_list_button.grid(row=0, column=1, padx=5)

load_word_list_button = ttk.Button(button_frame, text="Load Word List", style="TButton", command=load_word_list)
load_word_list_button.grid(row=0, column=2, padx=5)

process_button = tk.Button(app, text="Process Document", font=("Arial", 16), command=process_document)
