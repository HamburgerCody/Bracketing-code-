...
def process_text(input_text, word_list):
    try:
        ...
        logging.error(f"Error while processing text: {str(e)}")
        return None
...
def process_text_and_display():
    ...
    # Process the input text and handle errors
    ...
    if processed_text is not None:
        ...
        messagebox.showerror("Error", "Processing failed. Check the input text and word list.")
