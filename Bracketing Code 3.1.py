...
LOG_FILE = r"C:\Users\HamburgerC\Desktop\Bracketing code\bracketing.log"

# Configure logging with the specified log file
logging.basicConfig(filename=LOG_FILE, level=logging.ERROR)

def add_brackets_to_words_in_text(input_text, word_list):
...
def process_word_document(docx_filename, word_list, result_filename):
    ...
    for paragraph in doc.paragraphs:
        ...
        processed_paragraph = add_brackets_to_words_in_text(paragraph.text, word_list)
