...
def process_word_document(input_filename, word_list, result_filename, num_iterations=3):
    try:
        ...
        if os.path.exists(full_output_path):
            ...
            if not confirm:
                messagebox.showerror("Error", "Processing canceled.")
                return False
...
def process_file(file_path):
    try:
        ...
        messagebox.showerror("Error", f"An error occurred while processing the file. Error: {str(e)}")
...
def duplicate_folder(src_folder, dest_folder):
    try:
        ...
        messagebox.showerror("Error", f"An error occurred while duplicating the folder. Error: {str(e)}")
...
def process_folder(folder_path):
    try:
        ...
        messagebox.showerror("Error", f"An error occurred while processing the folder. Error: {str(e)}")
...
def process_markdown_file(md_file, word_list):
    try:
        ...
        messagebox.showerror("Error", f"An error occurred while processing the Markdown file. Error: {str(e)}")
