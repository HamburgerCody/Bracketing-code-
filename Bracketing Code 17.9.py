...
# Function to select a folder or Word document
def select_folder_or_document():
    ...
    if file_path:
        if file_path.endswith(".docx"):
            ...
            messagebox.showwarning("Warning", "Please select a valid Word document or folder.")
...
def start_gui():
    ...
    # Buttons to select a folder or Word document
    select_folder_or_doc_button = tk.Button(button_frame, text="Select Folder or Document", font=("Arial", 14), command=select_folder_or_document)
    select_folder_or_doc_button.grid(row=0, column=0, padx=5)
