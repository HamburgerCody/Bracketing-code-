...
def process_document(selected_document, text_box):
    try:
...
def start_gui():
    ...
    start_button = tk.Button(app, text="Start", font=("Arial", 14), command=lambda: process_document(selected_document, text_box))
