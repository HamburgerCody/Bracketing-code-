...
def process_document():
    ...
    change_working_directory()  # Set the working directory
...
# Function to change the working directory to your desired path
def change_working_directory():
    desired_path = r'C:\Users\HamburgerC\Desktop\Bracketing code'
...
save_word_list_button = tk.Button(app, text="Save Word List", fg="white", bg="#007AFF", font=("Arial", 14), command=save_word_list)
load_word_list_button = tk.Button(app, text="Load Word List", fg="white", bg="#007AFF", font=("Arial", 14), command=load_word_list)
