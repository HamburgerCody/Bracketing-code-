...
def select_folder():
    ...
    if folder_path:
        selected_document = folder_path  # Store the selected folder path

# Function to select a Word document
def select_document(text_box):
    global selected_document
    selected_document = None  # Reset the selected document
...
def start_gui():
    ...
    # Button to select a Word document
    select_document_button = tk.Button(app, text="Select Document", font=("Arial", 14), command=lambda: select_document(text_box))
    select_document_button.pack(pady=10)

    # Button to select a folder
    select_folder_button = tk.Button(app, text="Select Folder", font=("Arial", 14), command=select_folder)
    select_folder_button.pack(pady=10)

    # Button to process a selected Word document or folder
    start_button = tk.Button(app, text="Start", font=("Arial", 14), command=lambda: process_document(text_box))
