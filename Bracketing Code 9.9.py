...
save_button = tk.Button(app, text="Save Word List", fg="white", bg="#007AFF", font=("Arial", 14), command=save_word_list)
load_button = tk.Button(app, text="Load Word List", fg="white", bg="#007AFF", font=("Arial", 14), command=load_word_list)
