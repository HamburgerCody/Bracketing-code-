...
# Variable to store the selected document or folder path
selected_item = ""
...
def process_selected():
    ...
    try:
        ...
        logging.error(f"Error: An error occurred while processing the selected item. Error: {str(e)}")
...
def start_gui():
    ...
    start_button = tk.Button(app, text="Start", font=("Arial", 14), command=process_selected)
