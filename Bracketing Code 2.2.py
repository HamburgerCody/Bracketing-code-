...
if __name__ == "__main__":
    ...
    # Check if the output document already exists; if not, create it
    if not os.path.exists(output_docx_path):
        ...
        print(f"Error: The output file '{output_docx_path}' already exists. Please choose a different output path.")
