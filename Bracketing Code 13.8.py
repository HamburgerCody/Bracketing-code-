...
# Function to open a folder selection dialog and start processing the selected folder
def process_folder_dialog():
...
# Button to process a selected Word document
process_document_button = tk.Button(app, text="Process Selected Document", font=("Arial", 14), command=process_document)
process_document_button.pack(pady=10)

# Button to process a folder
process_folder_button = tk.Button(app, text="Select Folder", font=("Arial", 14), command=process_folder_dialog)
process_folder_button.pack(pady=10)

# Button to run both processes
run_processes_button = tk.Button(app, text="Run Both Processes", font=("Arial", 14), command=lambda: [process_document(), process_folder_dialog()])
run_processes_button.pack(pady=10)

# Variable to store the selected Word document
selected_document = None

# Button to select a Word document
select_document_button = tk.Button(app, text="Select Document", font=("Arial", 14), command=lambda: select_document())
select_document_button.pack(pady=10)

# Function to select a Word document
def select_document():
    global selected_document
    selected_document = filedialog.askopenfilename(filetypes=[("Word Document", "*.docx")], initialdir=initial_working_directory)
