...
def process_folder(folder_path):
    try:
        ...
        for md_file in md_files:
            ...
            # Process the Markdown content and create a Word document
            result_doc = docx.Document()
            result_doc.add_paragraph(md_content)
...
select_document_button = tk.Button(button_frame, text="Select Document", font=("Arial", 14), command=select_document)
...
start_button = tk.Button(button_frame, text="Start", font=("Arial", 14), command=start_processing)
